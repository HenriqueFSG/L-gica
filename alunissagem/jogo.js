...
function mostrarCombustivel(){
    ...
    contexto.fillStyle = "lightgray";
    contexto.fillText(
        `Combustivel: ${(moduloLunar.combustivel / 10).toFixed(0)} %`,
        50,
        80
    );
}
...
function atracaoGravitacional(){
    ...
    if(moduloLunar.motorLigado){
        moduloLunar.velocidade.y -= 0.016 * Math.cos(moduloLunar.angulo);
        moduloLunar.velocidade.x += 0.016 * Math.sin(moduloLunar.angulo);
    }
}
